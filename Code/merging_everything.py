# I am not sure where master is from.
# figure out: Master is in the large data ipynb. lot of initial exploration was there. 
# I merge initially in CRSP to get the stock price data for each 
import pandas as pd
import numpy as np
